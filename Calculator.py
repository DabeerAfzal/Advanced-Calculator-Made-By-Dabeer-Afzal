...
window.title("Simple Calculator made My Dabeer Afzal!")
window.iconbitmap("images/Calculator Icon.ico")
def btn_click(item):
    global expression
...
btns_frame = Frame(window, width = 312, height = 272.5, bg = "powder blue")
btns_frame.pack()
